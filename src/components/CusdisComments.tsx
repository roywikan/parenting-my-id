...
export const CusdisComments: React.FC<CusdisCommentsProps> = ({
  ...
  const [commentMode, setCommentMode] = useState<'native' | 'cusdis'>('native');
  ...
  // Cusdis Widget Loader
  useEffect(() => {
    if (commentMode !== 'cusdis') return;
  ...
  }, [commentMode, pageId, pageUrl, pageTitle, appId, host]);
            ...
            <form onSubmit={handleNativeSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white text-xs focus:ring-2 focus:ring-rose-500 outline-none transition-all"
                  />
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white text-xs focus:ring-2 focus:ring-rose-500 outline-none transition-all resize-none"
                />
              </div>
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-extrabold text-xs shadow-md transition-all flex items-center gap-2 disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
